---
title: "MCC signature genes incorporate with L1000 perturbagens"
author: "Jiawen Yang"
date: "2023-06-25"
output: 
  html_document:
...
# Loading libraries
```{r load library, include=TRUE, echo=TRUE, warning=F, message=F}
library(cmapR)
library(ggplot2)
library(ggrepel)
library(dplyr)
...
# Overlapping the NE1000 genes with perturbed top 1000 genes in LINCS L1000 data under different perturbagens
